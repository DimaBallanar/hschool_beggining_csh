...
//2)Пользователь вводит с клавиатуры 2 числа: основание степени и показатель степени. Необходимо возвести число во введенную степень
...
// 3)Напишите программу, которая считывает длины двух катетов в прямоугольном треугольнике и выводит его площадь. Используйте формулу: s=1/2*a*b
...
//4)Напишите скрипт, который определяет, какой температуре по шкале Цельсия соответствует указанное значение по шкале Фаренгейта 451
short F = 451;
int celsiy = (F- 32) / 9 * 5;
Console.WriteLine($"451 по Фаренгейту - это {celsiy} по Цельсию");

//5)Даны переменные a и b. Проверьте, что a делится без остатка на b. Если это так -выведите 'Делится' и результат деления, иначе выведите 'Делится с остатком' и,само значение деления
...
// 7)На вход программе подается число n – количество собачьих лет. Напишите программу, которая вычисляет возраст собаки в человеческих годах.
...
//9)Даны числа 4, -2, 5, 19, -130, 0, 10. Найти максимальное и минимальное число с помощью Math.Min и Math.Max
int a9 = 4;
int b9 = -2;
int c9 = 5;
int d9 = 19;
...
//10)Написать программу ,которая вычисляет обьем куба и площаль поверхности ,зная длину ребра
...
// 11)Напишите программу, в которой вычисляется сумма, разность, произведение двух целых чисел,которые введут с клавиатуры
Console.WriteLine("Введите первое число");
...
// 12)написать программу для пересчета временных интервалов ,заданных в минутах , в величину,выраженную в часах и минутах
Console.WriteLine("Введите количество минут:");
int minuti = Convert.ToInt32(Console.ReadLine());
Console.WriteLine($"{minuti/60} часов {minuti%60} минут");