...
// вывести текущую строку в большом регистре
{
    ...
    if (!string.IsNullOrEmpty(stro4ka))
    {
        if (int.TryParse(stro4ka, out _))
        {
        ...
        {
            System.Console.WriteLine(stro4ka.ToUpper());
        }
    }
}
...
// выяснить, четное или нет. Если это текст и равен “hschool”, вывести true. В противном случае false
{
